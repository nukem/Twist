				...
				<td>
				  <div class="blog-main">
					<table class="blog-rec-table">
						<tr>
							<td></td><td></td><td></td><td></td><td><a href="?id=<?php echo $cfg['blog']['id']; ?>&entry=1"><h3><img src="images/comment_add.gif" title="New Blog" />&nbsp;New Entry</h3></a></td>
						</tr>
					<?php
					...
					<?php
							...
							foreach($blog_list as $blog){
								...
								echo '<tr'. $bg_color . '><td><a href="?id=' . $cfg['blog']['id'] . '&action=edit&blog=' . $blog['id'] . '">' . $blog['title'] . '</a></td><td>' . $author[$blog['author']] . '</td><td>' . $blog['tags'] . '</td><td>' . $blog['date'] . '</td><td style="width: 80px;"><a href="?id=' . $cfg['blog']['id'] . '&action=edit&blog=' . $blog['id'] . '"><img src="images/comment_edit.gif" title="Edit Blog" /></a>&nbsp;&nbsp;&nbsp;<a href="?id=' . $cfg['blog']['id'] . '&action=delete&blog=' . $blog['id'] . '"><img src="images/comment_delete.gif" title="Delete Blog" /></a></td></tr>';
							}
						}
					?>
					</table>
