          ...
          <div class="width-99pct"> 
            <table class="rec-table"> 
              ...
              <tr> 
				...
				<input type="text" id="phone" name="phone" class="textfield width-100pct" value="<? echo show_value('phone') ?>" />
				</td>
				<td> 
				<label>Facsimile</label><br />
				<input type="text" id="fax" name="fax" class="textfield width-100pct" value="<? echo show_value('fax') ?>" />
				</td>
				<td> 
				<label>Email</label><br />
				<input type="text" id="email" name="email" class="textfield width-100pct" value="<? echo show_value('email') ?>" />
				</td>
				<td></td>
			</tr>
			<tr>
				<td>
<?php
$timetables = dbq('SELECT title, id FROM wp_structure WHERE type = "timetable"');
?>
					<label>Timetable</label><br/>
					<select name="additional" class="textfield width-100pct">
						<option></option>
<?php
foreach($timetables as $t) {
	$selected = '';
	if($_POST['additional'] == $t['id'] || $record['additional'] == $t['id']) {
...
<?php
$checked = '';
if($record['hq'] == 1 || $_POST['hq'] == 1) {
	$checked = 'checked="checked"';
}
?>
						<label>
							<input type="checkbox" name="hq" <?php echo $checked; ?> value="1" />
							Headquarters
						</label>
					</td>
				  <td>
<?php
$checked = '';
if($record['header'] == 1 || $_POST['header'] == 1) {
	$checked = 'checked="checked"';
}
?>
						<label>
							<input type="checkbox" name="header" <?php echo $checked; ?> value="1" />
							Include location in header
						</label>
					</td>
				</tr>
         ...
         <input type="text" id="address" name="address" class="textfield width-100pct" value="<? echo show_value('address') ?>" />
				</td>
<td> 
				<label>Suburb</label><br />
				<input type="text" id="suburb" name="suburb" class="textfield width-100pct" value="<? echo show_value('suburb') ?>" />
				</td>
<td> 
				<label>Postcode</label><br />
         <input type="text" id="postcode" name="postcode" class="textfield width-100pct" value="<? echo show_value('postcode') ?>" />
				</td>
<td> 
				<label>State</label><br />
				<input type="text" id="state" name="state" class="textfield width-100pct" value="<? echo show_value('state') ?>" />
				</td>
              </tr>
			  ...
			  <tr>
				  <td>
					  ...
					  <input type="text" id="lat" name="lat" class="textfield width-100pct" value="<? echo show_value('lat') ?>" />
				 </td>

				  <td>
					  <label>Longitude</label><br/>
					  <input type="text" id="lon" name="lon" class="textfield width-100pct" value="<? echo show_value('lon') ?>" />
				 </td>
			 </tr>
				<tr> 
				  <td colspan="4"> 
					  <label><?= $lang[59] ?></label><br />
					  <textarea name="content" cols="30" rows="25" class="textfield tinymce"><? if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['content']); else echo htmlspecialchars (preg_replace('/src="[^http]/', 'src="../', $record['content'])); ?></textarea>
				  </td> 
			  </tr>
			  <tr>
				<td colspan="2">
