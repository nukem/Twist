        ...
        <div class="right-col-padding1"> 
          <div class="width-99pct"> 
            <table class="rec-table"> 
              <? require ("tpl/inc/record.php"); ?> 
				<tr>
				  ...
				  <td colspan="2">
					  ...
					  <input type="text" class="textfield width-100pct" value="<?php echo show_value('price'); ?>" name="price" />
				  </td>

				  <td colspan="2">
					  <label>Product Code</label><br />
					  <input type="text" class="textfield width-100pct" value="<?php echo show_value('product_code'); ?>" name="product_code" />
				  </td>
			  </tr>
			  <tr>
				  <td colspan="4">
					  <table style="width:100%;">
					  	<tr>
							<td style="width:33%">
								<label>Product Postage (1 - 3 items)</label><br />
								<span>$</span><input type="text" class="textfield" style="width:60%" value="<?php echo show_value('product_postage1'); ?>" name="product_postage1" />
							</td>
							<td style="width:33%">
								<label>Product Postage (4+ items)</label><br />
								<span>$</span><input type="text" class="textfield" style="width:60%" value="<?php echo show_value('product_postage2'); ?>" name="product_postage2" />
							</td>
							<td style="width:33%">
								<label>Product Postage (International)</label><br />
								<span>$</span><input type="text" class="textfield" style="width:60%" value="<?php echo show_value('product_postage3'); ?>" name="product_postage3" />
							</td>
						</tr>
					  </table>
				  </td>
			  ...
			  <tr>
				  <td colspan="4">
					  <label>Seperate colour / size options with a commma (eg. small, medium, large)</label>
				  </td>
			  </tr>
			  <tr>
				  ...
				  <td colspan="2">
					  ...
					  <input type="text" class="textfield width-100pct" value="<?php echo show_value('colours'); ?>" name="colours" />
				  </td>

				  <td colspan="2">
					  <label>Sizes</label><br />
					  <input type="text" class="textfield width-100pct" value="<?php echo show_value('sizes'); ?>" name="sizes" />
				  </td>
			  </tr>
