          ...
          <div class="width-99pct"> 
            <table class="rec-table"> 
			  ...
			  <tr>
					...
					<td colspan="2">
						<label>Video Url (Youtube URL)</label><br/> 
						...
						<input type="button" class="button" value="Retrieve" name="update" id="update"/>
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						...
						<input type="text" id="image" name="image" cols="30" rows="10" class="textfield width-100pct" value="<?php echo show_value('image'); ?>" />
					</td>
					
<tr> 
                <td colspan="4"> 
				<label><?= $lang[59] ?></label><br />
         <textarea name="details" cols="30" rows="10" class="textfield height-200 tinymce"><? echo show_value('details'); ?></textarea>
                </td> 
              </tr>
