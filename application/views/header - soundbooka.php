...
// foreach($this->session->userdata('artists') as $artist){ $i++;?>
 <form method="post">
<input style="background-image:none;width: 120px !important;" type="button" value="Personal Info" class="input_continue" name="signin" onclick="window.location='<?=base_url()?>artist/personal_info/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
<input style="background-image:none;width: 120px !important;" type="button" value="Manage Profiles" class="input_continue" name="signin" onclick="window.location='<?=base_url()?>artist/manage_profile/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
