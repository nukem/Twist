...
<?php if($_SERVER['REQUEST_URI']=="/" || $_GET['REQUEST_URI']=="/index.php"){
echo"<title>Book Musicians in Australia (Sydney, Brisbane, Melbourne, etc) for Bars, Wedding and events | DJ | The Best Band, DJ & session musicians for hire in Sydney, Brisbane, Melbourne, Adelaide & Perth | Soundbooka</title>";
}else{ ?>
	...
	<meta property="og:title" content="Soundbooka" />
	<meta property="og:type" content="sports_team" />
	<meta property="og:url" content="<?=base_url()?>" />
	<meta property="og:image" content="<?=base_url()?>images/logo-small.png"/>
	<meta property="og:site_name" content="Soundbooka" />
...
<? endif; ?>
  ...
  <body>
    <div id="container">
      ...
      <div id="main" role="main" style="min-height:490px">
