...
#content {overflow:auto}
					...
					<div class="features">
								<div class="block-bar" style="margin:0;">
										...
										<a class="btn_login" id="book_artist" title="Book Artist" alt="Book Artist" href="javascript: void(0);" style="width: 100px !important; margin-top: 0px !important;">Book</a>
										<?php } ?>
										</div>
										<div class="right newright">
										<?php if($this->session->userdata('profile_type')=='booka') { ?>
										<input type="hidden" value="<?php echo $this->session->userdata('artist_id'); ?>" id="bookaid"/>
										<a class="fav button_continue" id="add_fav" title="Add to Favourite" alt="Add to Favourite" href="javascript: void(0);" style="width: 155px !important; margin-top: 0px !important;">Add to Favourite</a>
										<?php } ?>
										</div>
								</div>
								...
								<div class="gallery">
										<div class="block-content">
                                                ...
                                                <? foreach ($images as $i) : ?>
                                                <img src="<?= base_url() ?>resize/?f=<?=urlencode($i->id.'-medium.jpg') ?>&w=216&h=154" alt="artist" />
                                                <? 
													//break;
												endforeach; ?>
												<?php } else {
													echo '<img src="'.base_url().'images/dj-border.jpg" height= "154" alt="artist" width="216" />';
												}?>
                                                </div>
												</div>
												<!--<div class="thumbs">
												  ...
												  <div id="box" >
													...
													//print_r($plots);
													?>
													<a onClick="window.open('<?php echo $plots[0]->plot; ?>','mywindow','menubar=1,resizable=1,width=600,height=600,left=500,top=300,scrollbars=1');" alt="Stage Plot/Tech Rider" title="Stage Plot/Tech Rider" style=" cursor:pointer;"><div id="img3"></div></a>
													<?php }
										...
										<div class="block-content" style="overflow:auto">
												<div class="info">
														<div class="info-left">
																...
																?>
																		<p><?php 
																		echo '<div style="display:none;">arun'; print_r($gig_hours); echo '</div>'; if($gig_hours && $gig_hours != 0){ echo $gig_hours.'hours';} else{ echo 'N/A';} ?> </p>
																</div>
																<?php 
																			...
																			?>
																				...
																				<li>
																						...
																						<div class="details">
																								...
																								<p><a style="text-decoration : none;cursor:default;" alt="<?=$video->description?>" title="<?=$video->description?>"><?= substr($video->description,0,50) ?>...</a></p>
														...
														<ul>
																...
																<li>
																		...
																		<div class="details">
                                                                                ...
                                                                                <?= $audio->title ?> 
                                                                                <br />
                                                                                 <a style="text-decoration : none; cursor:default" title="<?=$audio->description?>" alt="<?=$audio->description?>"><?= substr($audio->description,0,50) ?>...</a>
                                                                                </p>
...
$(function() {
	...
	$('.play-video').click(function() {
		...
		$('.play-video-current').attr('class', 'play-video');
		
		if($(this).attr('class') == 'play-video') 
			$(this).attr('class', 'play-video-current');
		else $(this).attr('class', 'play-video');
